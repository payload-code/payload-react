declare module 'payload-react' {
  ...
  export interface PayloadInputProps
    extends React.HTMLAttributes<HTMLInputElement | HTMLDivElement>,
      InputEventProps {
    attr?: string
    'pl-input'?: string
  ...
  export class PayloadForm extends React.Component<PayloadFormProps> {
    formRef: React.RefObject<HTMLFormElement>
    submit(): Promise<unknown>
  }

  export const PaymentForm: React.ForwardRefExoticComponent<
    React.PropsWithoutRef<PayloadFormProps> & React.RefAttributes<PayloadForm>
  >
  ...
  export const Card: React.FC<PayloadInputProps>
  export const CardNumber: React.FC<PayloadInputProps>
  export const Expiry: React.FC<PayloadInputProps>
  export const CardCode: React.FC<PayloadInputProps>
  export const RoutingNumber: React.FC<PayloadInputProps>
  export const AccountNumber: React.FC<PayloadInputProps>

  export class ProcessingAccountForm extends React.Component<ProcessingAccountFormProps> {
